                    ...
                    <div class="row">
                        <div class="col-12 col-lg-6">
                            ...
                            <div class="contact__form">
                                <form class="form" method="POST" action="/contact/save-edit">
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="contact__form-input">
                                                <input type="email" class="form-input" name="email" value=${email} placeholder="Email...">
                                            </div>
                                        </div>
                                        <div class="col-12">
                                            <div class="contact__form-input">
                ...
                <div class="mobile__content">
                    ...
                    <div class="mobile__navigation">
                        <ul class="mobile__nav">
                            <li class="mobile__children"><a href="${root}/index" class="mobile__link">Trang chủ</li>
