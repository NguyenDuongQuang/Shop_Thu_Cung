				...
				<div class="container">
					<div class="bread-crumb">
						<span><a href="${root }/index">Trang chủ</a></span> <span><a
							href="${root }/contact">Liên hệ</a></span>
					</div>
				</div>
			</div>
										...
										<div class="col-md-6">
											<div class="contact__form-input">
												<input type="text" class="form-input" name="mobile"
													id="mobile" value="${contact.mobile }">
											</div>
										</div>
										<div class="col-md-6">
											<div class="contact__form-input">
										...
										<div class="col-12">
											<div class="contact__form-input">
												<textarea cols="30" rows="5" class="form__textarea"
													name="message" id="message" placeholder="Message">${contact.message }</textarea>
											</div>
										</div>
										<div class="col-12">
											<div class="contact__btn">
												<button onclick="_notification()" type="button"
...
<script type="text/javascript">
	function _notification() {
		//javascript object Lấy dữ liêu từ các ô input của form
		let data = {
