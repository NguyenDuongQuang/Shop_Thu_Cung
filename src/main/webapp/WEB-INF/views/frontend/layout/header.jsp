                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 block none">
                            <div class="header__bottom-menu">
                                <ul>
                                    <li class="header__bottom-menu-children"><a href="${root }/index">Trang chủ</a></li>
                                    <li class="header__bottom-menu-children">
                                        <a href="${root }/category">Thú cưng</a>
                                        <ul class="mega__subnav">
                                            <li class="mega__subnav-menu">
                                                <h4 class="mega__menu-title">Chó</h4>
                                                <ul class="mega__subnav-menu-2">
                                                    <li><a href="${root }/category">Chó Corgi</a></li>
                                                    <li><a href="${root }/category">Chó Beagle</a></li>
                                                    <li><a href="${root }/category">Chó Alaska Malamute</a></li>
                                                    <li><a href="${root }/category">Chó Golden Retriever</a></li>
                                                    <li><a href="${root }/category">Chó Husky Siberian</a></li>
                                                    <li><a href="${root }/category">Chó Phốc Sóc – Pomeranian</a></li>
                                                </ul>
                                            </li>
                                            <li class="mega__subnav-menu">
                                                <h4 class="mega__menu-title">Mèo</h4>
                                                <ul class="mega__subnav-menu-2">
                                                    <li><a href="${root }/category">Mèo Anh (Dài + Ngắn)</a></li>
                                                    <li><a href="${root }/category">Mèo Chân Ngắn</a></li>
                                                    <li><a href="${root }/category">Mèo Tai Cụp</a></li>
                                                    <li><a href="${root }/category">Mèo Xiêm</a></li>
                                                    <li><a href="${root }/category">Mèo Ba Tư</a></li>
                                                    <li><a href="${root }/category">Mèo Chinchilla</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </li>
                                    ...
                                    <li class="header__bottom-menu-children"><a href="${root }/contact/view">Liên hệ</a></li>
                                </ul>
                            </div>
                        </div>
